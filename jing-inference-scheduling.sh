...
export LLMDBENCH_GATEWAY_API_CRD_REVISION="v1.3.0"
...
export LLMDBENCH_CONTROL_WORK_DIR=~/data/tmp
...
export LLMDBENCH_IMAGE_TAG="0.0.17"

export LLMDBENCH_IGNORE_FAILED_VALIDATION=true
export LLMDBENCH_VLLM_COMMON_ACCELERATOR_RESOURCE=NVIDIA-H100-80GB-HBM3

# export LLMDBENCH_VLLM_COMMON_MAX_MODEL_LEN=100000000000
...
# export LLMDBENCH_VLLM_MODELSERVICE_PREFILL_ACCELERATOR_NR=2