...
# Set via experiment file
export LLMDBENCH_VLLM_MODELSERVICE_GAIE_PLUGINS_CONFIGFILE="inf-sche-queue.yaml"
...
export LLMDBENCH_CONTROL_WORK_DIR=~/data/qwen0-6/inf-sche-9-26
...
export LLMDBENCH_IMAGE_TAG="0.0.16"
